...
INSERT INTO `price_update_history` VALUES ('TE0200',1289,1280,'2022-12-30 17:45:10'),('TE0200',1280,1200,'2022-12-30 17:45:53');
...
INSERT INTO `products` VALUES (2,'TE0200','Learning & Education','Wooden Alphabet Characters','',1200,NULL);
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `products_price_archive` AFTER UPDATE ON `products` FOR EACH ROW BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `products_cart_price_updater` AFTER UPDATE ON `products` FOR EACH ROW BEGIN
...
-- Dump completed on 2022-12-30 23:21:50
